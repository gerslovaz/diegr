...
#'   \item{D2}{A tibble with 3 columns containing x and y coordinates and labels of sensors in 2D}
#'   \item{D3}{A tibble with 4 columns containing x, y and z coordinates and labels of sensors in 3D. See 'Details' for more information.}
...
#'
#' The 2D coordinates were created by EGI team by positioning the channels to maximize use of screen space and to preserve a head shape, as much as possible.
#'
#' @keywords dataset
#'
