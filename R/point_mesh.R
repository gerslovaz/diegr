...
#' @param template The kind of sensor template montage used. Default setting 'HCGSN256' denotes the 256-channel HydroCel Geodesic Sensor Net v.1.0 (currently the only available option).
...
#' @param type A character indicating the shape of the mesh with 2 possible values: 'circle' for circular mesh (default), 'polygon' for irregular polygon shape with boundaries defined by sensor locations.
#'
#' @details
