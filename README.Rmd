...
For more information about the structure of built-in data and conversion from Matlab hdf5 files to database tables using R see [the diegr vignette](doc/diegr.html).
...
For more examples and basic informations about using the package see [the diegr vignette](doc/diegr.html).
