...
-   scalp plots in 3D
-   functions for computing baseline correction, pointwise and jackknife mean
-   functions for plotting the mean with pointwise confidence interval
-   animations of time course of the raw signal or the average in 2D and 3D
...
For more information about the structure of built-in data and conversion from Matlab hdf5 files to database tables using R see the package vignette `vignette("diegr", package = "diegr")`.
...
For detailed examples and explanations, please see the package vignette: `vignette("diegr", package = "diegr")`.
