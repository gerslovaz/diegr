...
# open3d()
# shade3d(mesh3d(x = M4.3d$x, y = M4.3d$y, z = M4.3d$z, triangles = t(TRIMAT)), col = yc12, lit = F)
#
...
# X.Pcp <- XP_IM(HCGSN256$D2, M3[,1:2]) # pocita to docela dlouho uz na 30tis. siti, chce to nejak optimalizovat
# y.Pcp <- X.Pcp%*%beta.hat
# #ycp.IM2 <- M3[,1]
# ycp.IM2 <- y.Pcp[1:length(M3[,1])]
# yc12cut <- cut(ycp.IM2, breaks = CS12$breaks, include.lowest = TRUE)
# yc12 <- CS12$colors[yc12cut]
