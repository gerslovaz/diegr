...
test_that("point_mesh dim = 2 output containes D2 with named columns", {
  M <- point_mesh(dim = 2, n = 1000, template = "HCGSN256")
...
test_that("point_mesh dim = 3 output containes D3 with named columns", {
  M <- point_mesh(dim = 3, n = 1000, template = "HCGSN256")
