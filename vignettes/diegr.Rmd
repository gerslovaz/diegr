...
The function allows setting some optionally arguments for editing the output appearance (with or without contours, sensor names, etc.) and further customization is for users available through output in the form of \code{\link[ggplot2]{ggplot}} function. 
...
The `rgl` output enables to rotate the image with default view of the back of the head.
